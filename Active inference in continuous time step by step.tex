...
Often optimizing $F$ for arbitrary $Q(x)$ is particularly complex. Moreover, assumed that neural activity parametrise sufficient statistic, a common approximation is to assume that  
